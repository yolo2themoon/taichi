...
class KernelProfiler:
    ...
    def print_info(self, mode=COUNT):
        ...
        another mode ``TRACE``: print the records of launched Taichi kernels with specific profiling metrics
        (time, memory load/store and core utilization etc.)
...
def get_default_kernel_profiler():
    ...
    For data retention purposes, support for multiple instances will be considered in the future.
    """
