...
option(TI_WITH_TOOLKIT_CUDA "Build with CUDA toolkit" OFF)
...
if (TI_WITH_TOOLKIT_CUDA)
    message( "CUDA_INCLUDE_PATH = $ENV{CUDA_INCLUDE_PATH}" )
    message( "CUDA_LIBRARY_PATH = $ENV{CUDA_LIBRARY_PATH}" )
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -DTI_WITH_TOOLKIT_CUDA")
    include_directories($ENV{CUDA_INCLUDE_PATH})
    link_directories($ENV{CUDA_LIBRARY_PATH})
    target_link_libraries(${CORE_LIBRARY_NAME} nvperf_host)
    target_link_libraries(${CORE_LIBRARY_NAME} cupti)
endif()
